...
export default function LectureMaterialList({ lectureId }) {
  ...
  const load = () => {
    fetch(`https://hilearnlmstool-production.up.railway.app/api/materials/lecture/${lectureId}`)
      .then(res => res.json())
  ...
  const remove = async (id) => {
    await fetch(`https://hilearnlmstool-production.up.railway.app/api/materials/${id}`, { method:"DELETE" });
    load();
  };
