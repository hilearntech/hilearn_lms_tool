        ...
        <div className="p-4 sm:p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4 sm:mb-6">
                ...
                <button
                    ...
                    className="w-full sm:w-auto px-4 sm:px-6 py-2 rounded-2xl font-bold text-white bg-[#059669] hover:bg-[#047857] shadow-md transition-all text-sm sm:text-base"
                >
                    ADD STUDENT
                </button>
            </div>
            ...
            {loading ? (
                <p className="text-[#059669] font-bold text-sm sm:text-base">
                    Loading students...
                </p>
            ) : (
                <div className="overflow-x-auto bg-white rounded-xl shadow">
                                    ...
                                    <td className="py-3 sm:py-4">
                                        <div className="flex flex-wrap gap-2 sm:gap-4 justify-center">
                                            ...
                                            <button
                                                ...
                                                className="text-[#059669] font-bold hover:underline text-xs sm:text-sm"
                                            >
                                                Edit
                                            </button>
                                            ...
                                            <button
                                                ...
                                                className={`relative w-9 sm:w-10 h-5 flex items-center rounded-full transition-colors ${
                                                    student.isActive
                                                        ? "bg-green-500"
                                                        : "bg-red-500"
                                                }`}
                                            >
                                                <span
                                                    ...
                                                    style={{
                                                        left: student.isActive ? "22px" : "5px",
                                                    }}
                                                />
                                            </button>
                                            ...
                                            <button
                                                ...
                                                className="text-red-600 font-bold hover:underline text-xs sm:text-sm"
                                            >
                                                Delete
                                            </button>
                                            ...
                                            <button
                                                ...
                                                className="text-gray-600 font-bold hover:underline text-xs sm:text-sm"
                                            >
                                                View
                                            </button>
