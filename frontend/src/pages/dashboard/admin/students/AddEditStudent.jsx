...
const AddEditStudent = () => {
  ...
  <h1 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-[#059669] text-center sm:text-left">
    {id ? "Edit Student" : "Add Student"}
  </h1>

  <form className="bg-white p-4 sm:p-6 rounded-xl shadow space-y-4" onSubmit={handleSubmit}>
    ...
    <input
      ...
      className="w-full border p-2.5 sm:p-3 rounded focus:border-[#059669] outline-none text-sm sm:text-base"
      required
    />
    ...
    <div className="flex flex-col gap-1">
      ...
      <select
        value={formData.enrolledCourse}
        onChange={e => setFormData({ ...formData, enrolledCourse: e.target.value })}
        className="w-full border p-2.5 sm:p-3 rounded focus:border-[#059669] outline-none bg-white cursor-pointer text-sm sm:text-base"
      >
        <option value="">Select a Course</option>
        {courses.map(course => (
          <option key={course._id} value={course._id}>
    ...
    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
      <button
        type="submit"
        className="w-full sm:flex-1 bg-[#059669] text-white py-2.5 sm:py-3 rounded font-semibold hover:bg-[#047857] text-sm sm:text-base"
      >
      ...
      <button
        ...
        className="w-full sm:flex-1 border py-2.5 sm:py-3 rounded font-semibold hover:bg-gray-50 text-sm sm:text-base"
      >
        Cancel
      </button>
    </div>
