...
import { Send, LayoutGrid, Type, Clock, AlignLeft, Layers, Calendar, VideoIcon, User } from "lucide-react";
...
const AddEditLecture = ({ refreshLectures, editData, clearEdit }) => {
  ...
  const [form, setForm] = useState({
    ...
    lectureType: "video", date: "", startTime: "",
    isPreviewFree: false,
      ...
      <form onSubmit={submit} className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        {form.lectureType === 'live' && (
          <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <p className="md:col-span-2 text-[11px] text-emerald-600 font-semibold italic px-1">Meeting link will be auto-generated by BBB when you start the class.</p>
          </div>
        )}
