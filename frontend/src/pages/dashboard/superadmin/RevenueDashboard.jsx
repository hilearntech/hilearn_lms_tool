        ...
        <div className="p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                ...
                <div className="bg-white p-4 sm:p-6 rounded-xl shadow border-l-4 border-blue-500">
                    <p className="text-gray-500 text-xs sm:text-sm">GST (18%)</p>
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-800">
                        ₹{stats.gst}
                    </h2>
                </div>

                <div className="bg-white p-4 sm:p-6 rounded-xl shadow border-l-4 border-red-500">
                    <p className="text-gray-500 text-xs sm:text-sm">Refunds</p>
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-800">
                        ₹{stats.refunds}
                    </h2>
                </div>
            ...
            <div className="bg-white rounded-xl shadow border border-gray-100">
                ...
                <div className="md:hidden divide-y">
                    {transactions.map((txn) => (
                        <div key={txn._id} className="p-4 space-y-2">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    onClick={() => generateInvoice(txn)}
                                    className="text-xs text-[#059669] font-semibold bg-green-50 px-3 py-1 rounded"
                                >
                                    Invoice
                                </button>
                            </div>
