  ...
  return (
    <div className="h-screen flex bg-slate-50 overflow-hidden">
      ...
      <aside
        ...
        `}
      >
        <div className="p-8 text-2xl font-black italic tracking-tighter flex items-center justify-between flex-shrink-0">
          HiLearn
          <button
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        {/* HEADER */}
        <header className="h-16 bg-white border-b flex items-center justify-between px-4 sm:px-8 flex-shrink-0 z-50 shadow-sm">
        ...
        {/* CONTENT */}
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 no-scrollbar" style={hideScrollbar}>
          <Outlet />
        </main>
      </div>
    </div>
