...
const AttendancePage = () => {
  ...
  return (
    <div className="space-y-6 px-4 sm:px-6 md:px-6">
      ...
      {/* HEADER */}
      <div className="bg-white p-5 sm:p-6 md:p-8 rounded-[32px] border border-slate-100 shadow-sm 
  flex flex-col sm:flex-col md:flex-row md:justify-between md:items-center gap-4">
        ...
        <div className="text-left md:text-right">
          ...
          <h3 className="text-3xl sm:text-4xl font-black text-[#059669]">
            {percentage}%
          </h3>
        </div>
      </div>
            ...
            {attendanceList.length > 0 ? (
              attendanceList.map((record) => (
                <tr key={record._id} className="hover:bg-emerald-50/30 transition-colors">
                  ...
                  <td className="px-8 py-6">
                    <div className="flex justify-center">
                      <span className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase flex items-center gap-1.5 border ${record.status.toLowerCase() === "present"
                          ? "bg-emerald-50 text-emerald-600 border-emerald-100"
                          : "bg-red-50 text-red-600 border-red-100"
                        }`}>
                        {record.status.toLowerCase() === "present"
            ...
            attendanceList.map((record) => (
              ...
              <div key={record._id} className="p-4 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase flex items-center gap-1 border ${record.status.toLowerCase() === "present"
                      ? "bg-emerald-50 text-emerald-600 border-emerald-100"
                      : "bg-red-50 text-red-600 border-red-100"
                    }`}>
                    {record.status.toLowerCase() === "present"
